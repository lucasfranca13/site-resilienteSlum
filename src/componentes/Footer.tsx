          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-muted-foreground">
                ...
                <span className="font-body text-sm">Ventosa, Belo Horizonte - MG</span>
              </li>
              <li className="flex items-center gap-3 text-muted-foreground">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-body text-sm hover:text-foreground transition-colors"
                >
                  (31) 9 8657-5234
                </a>
              </li>
              <li className="flex items-center gap-3 text-muted-foreground">
                ...
                <a href="mailto:resilienteslum@gmail.com" className="font-body text-sm hover:text-foreground transition-colors">
